...
export const skillDescriptions: Word[] = [
  ...
  { source: 'duanchang_description', target: '<b>鎖定技</b>，當你死亡時，殺死你的角色失去所有技能。' },
  {
    ...
    target:
      '遊戲開始時，你隨機將武將牌堆裡的三張牌扣置於你的武將牌上，稱為“化身”，並亮出其中一張且擁有其上由你選擇的一個技能（限定技、覺醒技、使命技、隱匿技和主公技除外），然後你的性別及勢力視為與此“化身”相同；回合開始或回合結束時，你可以選擇一項：1.變更亮出的“化身”；2.移去一至兩張未亮出的“化身”並獲得等量新“化身”。',
  },
