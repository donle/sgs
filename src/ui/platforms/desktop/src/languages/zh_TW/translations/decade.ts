...
export const skillDescriptions: Word[] = [
  {
    ...
    target: '你的第一個回合開始時，你可以獲得一至X名其他角色的各一張手牌（X為你的體力值）。',
  },
  {
    source: 'liewei_description',
    target: '每回合限X次（X為你的體力值），當你令其他角色進入瀕死狀態時，你可以摸一張牌。',
  },
...

  {
    ...
    target:
      '出牌階段開始時，你可以減1點體力上限，然後棄置距離1以內的所有角色各一張牌或令這些角色各摸一張牌；出牌階段結束時，若你的體力上限為全場最少，你加1點體力上限。',
  },
  ...
  },
  {
    ...
    target: '<b>鎖定技</b>，當你於回合外成為【殺】或傷害類錦囊牌的唯一目標後，若你沒有手牌，你摸兩張牌。',
  },
