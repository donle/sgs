...
export const skillDescriptions: Word[] = [
  ...
  },
  {
    ...
    target:
      '<b>使命技</b>，遊戲開始時，你令所有沒有“圍”的其他角色各獲得一枚“圍”標記；有“圍”標記的角色的回合開始時，你可以選擇一項，令你於本回合內視為處於其攻擊範圍內：1.棄置一張手牌，對其造成1點傷害；2.若其體力值不大於你，你獲得其一張手牌。回合開始時，你令所有有“圍”標記的角色將其“圍”標記移至除你外的下家角色。<br><b>成功</b>：回合開始時，若場上沒有“圍”標記，你獲得技能“神著”。<br><b>失敗</b>：當你進入瀕死狀態時，若你的體力小於0，你將體力回覆至1點，然後你移去場上的所有“圍”標記，並棄置你裝備區裡的所有牌。',
  },
  {
