...
export const skillDescriptions: Word[] = [
...

  {
    ...
    target:
      '當你於出牌階段對其他角色造成傷害後，你可以廢除一個裝備欄，然後選擇其武將牌上的一項技能（限定技、覺醒技、使命技、隱匿技和主公技除外），令其於其下回合結束之前此技能無效，且你於其下回合結束或其死亡之前擁有此技能且不能發動“奪銳”。',
  },
  {
...

  {
    ...
    target: '<b>鎖定技</b>，當你成為體力值大於你的角色使用【殺】的目標時，你判定，若結果為紅桃，取消之。',
  },
  {
    source: 'powei_description',
    target:
      '<b>使命技</b>，遊戲開始時，你令所有沒有“圍”的其他角色各獲得一枚“圍”標記；有“圍”標記的角色受到傷害後，移去其“圍”標記；有“圍”標記的角色的回合開始時，你可以選擇一項，令你於本回合內視為處於其攻擊範圍內：1.棄置一張手牌，對其造成1點傷害；2.若其體力值不大於你，你獲得其一張手牌。回合開始時，你令所有有“圍”標記的角色將其“圍”標記移至除你外的下家角色。<br><b>成功</b>：回合開始時，若場上沒有“圍”標記，你獲得技能“神著”。<br><b>失敗</b>：當你進入瀕死狀態時，若你的體力小於0，你將體力回覆至1點，然後你移去場上的所有“圍”標記，並棄置你裝備區裡的所有牌。',
  },
  {
  ...
  },
  {
    ...
    target:
      '出牌階段限一次，你可以令體力上限大於1的一名其他角色減1點體力上限並獲得1枚“平定”標記，然後你減1點體力上限；你對有“平定”標記的角色使用牌無距離限制。',
  },
  {
    source: 'god_fuhai_description',
    target:
      '<b>鎖定技</b>，當你使用牌時，你令目標中有“平定”標記的角色不可響應此牌；當你使用牌指定有“平定”標記的角色為目標時，你摸一張牌（每回合限兩次）；當有“平定”標記的其他角色死亡時，你加等同於其“平定”標記數的體力上限，並摸等量的牌。',
  },
  {
  ...
  },
  {
    ...
    target: '<b>鎖定技</b>，遊戲開始時，將8張【奇正相生】洗入牌堆；【奇正相生】對你無效。',
  },
  {
    source: 'lingce_description',
    target:
      '<b>鎖定技</b>，當一名角色使用非虛擬且非轉化的錦囊牌時，若此牌為智囊牌、“定漢”已記錄的牌或【奇正相生】，你摸一張牌。',
  },
  {
    source: 'dinghan_description',
    target:
      '當你成為未被本技能記錄的錦囊牌的目標時，本技能記錄此牌名，然後取消之；回合開始時，你可以在本技能的記錄中增加或移除一種錦囊牌的牌名。',
  },
