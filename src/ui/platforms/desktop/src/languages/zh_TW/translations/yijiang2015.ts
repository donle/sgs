...
export const skillDescriptions: Word[] = [
  {
    ...
    target: '當你受到傷害後，你可以令一名角色判定，若結果為：紅色，其回覆1點體力；黑色，其摸X張牌（X為傷害值）。',
  },
  {
  ...
  },
  {
    ...
    target:
      '<b>主公技</b>，當你進入瀕死狀態時，若你的體力值不大於0，你可以令其他魏勢力角色依次選擇是否令你回覆1點體力。此瀕死結算結束後，所有以此法令你回覆體力的角色各受到1點傷害。',
  },

  {
    source: 'qianju_description',
    target: '<b>鎖定技</b>，你計算與其他角色的距離-X（X為你已損失的體力值）。',
  },
  {
    source: 'qingxi_description',
    target:
      '當你使用【殺】或【決鬥】指定目標後，你可以令其選擇一項：1.棄置X張手牌（X為你攻擊範圍內的角色數且至多為2，若你的裝備區裡有武器牌，則改為至多為4），然後棄置你裝備區裡的武器牌；2.令此牌對其傷害基數+1且你判定，若結果為紅色，其不能響應此牌。',
  },

  {
    source: 'huomo_description',
    target:
      '當你需要使用基本牌時（你本回合使用過的基本牌除外），你可以將一張黑色非基本牌置於牌堆頂，視為使用此基本牌。',
  },
  {
...

  {
    ...
    target:
      '出牌階段限一次，你可以令你與一名其他角色同時展示一張手牌，若你展示的：為【殺】且其展示的不為【閃】，你對其造成1點傷害；不為【殺】且其展示的為【閃】，你獲得其一張牌。',
  },
  {
    source: 'shizhi_description',
    target:
      '<b>鎖定技</b>，若你的體力值為1，你的【閃】均視為【殺】；當你使用以此法視為的【殺】造成傷害後，你回覆1點體力。',
  },
...

  {
    ...
    target:
      '出牌階段限一次，你可以選擇一名其他角色，若其為手牌數最少的角色，其摸一張牌。若其為體力值最少的角色，其回覆1點體力。若其為裝備區裡牌數最少的角色，其從牌堆裡隨機使用一張裝備牌。最後若其有未執行的效果且你滿足條件，你依次執行對應效果。',
  },

  {
    source: 'huaiyi_description',
    target:
      '出牌階段限一次，你可以展示所有手牌，若其中：所有牌顏色相同，你摸一張牌，且本技能於此階段內改為“出牌階段限兩次”；有顏色不同的牌，你選擇一種顏色，棄置你手牌中該顏色的所有牌，然後你獲得一至多X名其他角色各一張牌，若你以此法獲得的牌數不少於兩張，你失去1點體力。',
  },

  {
    source: 'jigong_description',
    target:
      '出牌階段開始時，你可以摸一至三張牌，令你本回合內手牌上限為X（X為你此階段內造成過的傷害值）。若如此做，本回合你的下個棄牌階段開始時，若X不小於你此次摸的牌數，你回覆1點體力。',
  },
  {
    source: 'shifei_description',
    target:
      '當你需要使用或打出【閃】時，你可以令當前回合角色摸一張牌，然後若其不為手牌數唯一最多的角色，你可以棄置手牌數最多的一名角色的一張牌，視為使用或打出【閃】。',
  },
];
