...
export const UiDictionary: Word[] = [
  ...
  { source: 'system notification', target: '系統公告' },
  { source: 'ready', target: '已準備' },
  { source: 'cancel ready', target: '取消準備' },
  { source: 'get ready', target: '準備' },
  { source: 'enable observer', target: '允許旁觀' },
  { source: '{0} time limit', target: '{0}操作時間' },
  { source: 'game mode', target: '遊戲模式' },
  { source: 'character package settings', target: '武將擴充套件包設定' },
  { source: 'start game', target: '開始遊戲' },
  { source: 'second', target: '秒' },
  { source: 'save settings', target: '儲存設定' },
  { source: 'campaign', target: '單人遊戲' },
  { source: 'multi online', target: '聯機遊戲' },
  { source: 'room host has been changed to {0}', target: '{0} 成為了新房主' },
  { source: 'pve mode selection', target: 'PvE模式選擇' },
  { source: 'back to waiting room', target: '返回房間' },
  { source: 'give host', target: '設為房主' },
  { source: 'forbidden characters', target: '禁用武將列表' },
  { source: 'search character by name', target: '輸入武將名' },
  { source: 'observer {0} join in the room', target: '{0} 加入了旁觀' },
  { source: 'Observe', target: '旁觀' },
  {
    source: 'Room running with exceptions, please re-create your room',
    target: '房間出現錯誤，請退出房間重新建立遊戲',
  },
  { source: 'do you wanna change your handcards?', target: '是否使用手氣卡？' },
  { source: 'fortune card exchange limit', target: '手氣卡次數' },
  { source: 'times', target: '次' },
  { source: 'free to choose characters', target: '自由選將' },
];
