...
export const characterDictionary: Word[] = [
  { source: 'caocao', target: 'Cao Cao' },
  { source: 'hujia', target: 'Royal Escort' },
  { source: 'jianxiong', target: 'Villainous Hero' },

  { source: 'simayi', target: 'Sima Yi' },
  { source: 'fankui', target: 'Retaliation' },
  { source: 'guicai', target: 'Demonic Talent' },

  { source: 'xiahoudun', target: 'Xiahou Dun' },
  { source: 'ganglie', target: 'Unyielding' },
  { source: 'qingjian', target: 'Frugal' },

  { source: 'zhangliao', target: 'Zhang Liao' },
  { source: 'tuxi', target: 'Sudden Strike' },

  { source: 'xuchu', target: 'Xu Chu' },
  { source: 'luoyi', target: 'Bare Chested' },
  { source: '#luoyi', target: 'Bare Chested' },

  { source: 'guojia', target: 'Guo Jia' },
  { source: 'tiandu', target: 'Envy of Heaven' },
  { source: 'yiji', target: 'Bequeathed Strategy' },
  { source: '#yiji', target: 'Bequeathed Strategy' },

  { source: 'zhenji', target: 'Zhen Ji' },
  { source: 'luoshen', target: 'Goddess Luo' },
  { source: '#luoshen', target: 'Goddess Luo' },
  { source: 'qingguo', target: 'Helen of Troy' },

  { source: 'lidian', target: 'Li Dian' },
  { source: 'xunxun', target: 'Sincerity' },
  { source: 'wangxi', target: 'Forgiveness' },

  { source: 'caozhang', target: 'Cao Zhang' },
  { source: 'jiangchi', target: 'Versatile Fighter' },

  { source: 'liubei', target: 'Liu Bei' },
  { source: 'rende', target: 'Benevolence' },
  { source: 'jijiang', target: 'Rouse' },
  { source: '#jijiang', target: 'Rouse' },

  { source: 'guanyu', target: 'Guan Yu' },
  { source: 'wusheng', target: 'Warrior Saint' },
  { source: 'yijue', target: 'Absolute Justice' },
  { source: '#yijue', target: 'Absolute Justice' },

  { source: 'zhangfei', target: 'Zhang Fei' },
  { source: 'paoxiao', target: 'Roar' },
  { source: 'paoxiao DMG: {0}', target: 'Roar[{0}]' },
  { source: 'tishen', target: 'Replacement' },

  { source: 'zhugeliang', target: 'Zhuge Liang' },
  { source: 'guanxing', target: 'Stargaze' },
  { source: 'kongcheng', target: 'Empty Fort' },

  { source: 'zhaoyun', target: 'Zhao Yun' },
  { source: 'longdan', target: 'Dragon Heart' },
  { source: 'yajiao', target: 'Cornering Maneuver' },

  { source: 'machao', target: 'Ma Chao' },
  { source: 'mashu', target: 'Horsemanship' },
  { source: 'tieji', target: 'Iron Cavalry' },

  { source: 'huangyueying', target: 'Huang Yueying' },
  { source: 'jizhi', target: 'Wisdom' },
  { source: '#jizhi', target: 'Wisdom' },
  { source: 'qicai', target: 'Genius' },
  { source: '#qicai', target: 'Genius' },

  { source: 'yiji_c', target: 'Yi Ji' },
  { source: 'jijie', target: 'Agile' },
  { source: 'jiyuan', target: 'Urgent Aid' },

  { source: 'jiexushu', target: 'Xu Shu' },
  { source: 'zhuhai', target: 'Punishment' },
  { source: 'qianxin', target: 'Latent Intelligence' },
  { source: 'jianyan', target: 'Introduction' },

  { source: 'sunquan', target: 'Sun Quan' },
  { source: 'zhiheng', target: 'Balance of Power' },
  { source: 'jiuyuan', target: 'Rescued' },

  { source: 'ganning', target: 'Gan Ning' },
  { source: 'qixi', target: 'Surprise Raid' },
  { source: 'fenwei', target: 'Prestige' },

  { source: 'lvmeng', target: 'Lv Meng' },
  { source: 'qinxue', target: 'Diligence' },
  { source: 'keji', target: 'Self Mastery' },
  { source: 'botu', target: 'Erudite' },

  { source: 'huanggai', target: 'Huang Gai' },
  { source: 'kurou', target: 'Self Injury' },
  { source: 'zhaxiang', target: 'Fake Surrender' },

  { source: 'zhouyu', target: 'Zhou Yu' },
  { source: 'yingzi', target: 'Handsome' },
  { source: 'fanjian', target: 'Sow Dissension' },

  { source: 'daqiao', target: 'Da Qiao' },
  { source: 'guose', target: 'National Beauty' },
  { source: 'liuli', target: 'Shirk' },

  { source: 'luxun', target: 'Lu Xun' },
  { source: 'qianxun', target: 'Humility' },
  { source: 'lianying', target: 'One After Another' },

  { source: 'sunshangxiang', target: 'Sun Shangxiang' },
  { source: 'jieyin', target: 'Marriage' },
  { source: 'xiaoji', target: 'Warrior Lady' },

  { source: 'huatuo', target: 'Hua Tuo' },
  { source: 'jijiu', target: 'First Aid' },
  { source: 'qingnang', target: 'Green Salve' },

  { source: 'lvbu', target: 'Lv bu' },
  { source: 'wushuang', target: 'Without Equal' },
  { source: 'liyu', target: 'Bribery' },

  { source: 'diaochan', target: 'Diao Chan' },
  { source: 'lijian', target: 'Seed of Animosity' },
  { source: 'biyue', target: 'Envious by Moon' },

  { source: 'huaxiong', target: 'Hua Xiong' },
  { source: 'yaowu', target: 'Military Glory' },

  { source: 'yuanshu', target: 'Yuan Shu' },
  { source: 'wangzun', target: 'Treason' },
  { source: 'tongji', target: 'Hated' },

  { source: 'gongsunzan', target: 'Gongsun Zan' },
  { source: 'qiaomeng', target: 'Fierce Mount' },
  { source: 'yicong', target: 'Follower of Virtue' },
];
...
export const skillAudios: Word[] = [
  ...
  {
    source: '$jiangchi:2',
    target: '数从征伐，志意慷慨，不避险阻！',
  },

  {
    source: '$rende:1',
    target: '施仁布泽，乃我大汉立国之本！',
  },
  {
    source: '$rende:2',
    target: '同心同德，救困扶危！',
