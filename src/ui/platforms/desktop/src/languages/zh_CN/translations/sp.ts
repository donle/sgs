...
export const skillDescriptions: Word[] = [
...

  {
    ...
    target:
      '当一名角色于其出牌阶段内回复体力后，你可以选择一项：1.你摸一张牌；2.令其摸两张牌。',
  },
  {
    source: 'fanxiang_description',
    target: '<b>觉醒技</b>，准备阶段开始时，若场上有已受伤且你发动过良助选项2令其摸牌的角色，你增加1点体力上限并回复1点体力，失去技能“良助”，获得技能“枭姬”。',
  },
...

  {
    ...
    target: '出牌阶段，你可以将一张【杀】交给本回合内未成为过你发动此技能的目标的一名其他角色。当其于其下个回合结束前使用此牌时，你摸一张牌。',
  },
...

  {
    ...
    target: '摸牌阶段，你可以多摸X张牌（X为已受伤的角色数）。若如此做，当你于本回合内使用【杀】或普通锦囊牌时，你弃置一张牌。',
  },
  {
