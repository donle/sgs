...
export const skillDescriptionriptions: Word[] = [
  ...
  { source: 'shenduan_description', target: '当你的一张黑色基本牌弃置后，你可以将此牌当【兵粮寸断】使用。' },
  {
    source: 'yonglue_description',
    target:
      '其它角色的判定阶段开始时，若其在你攻击范围内，你可以弃置其判定区里的一张牌，然后视为你对其使用一张【杀】，若此【杀】没有造成过伤害，则你摸一张牌。',
  },
  ...
  { source: 'faen_description', target: '当一名角色翻至正面或横置后，你可以令其摸一张牌。' },
  ...
  },
  {
    ...
    target: '回合结束时，你可以对至多X名其它角色各造成1点伤害（X为你本回合跳过的阶段数）。',
  },

  { source: 'shenxing_description', target: '出牌阶段，你可以弃置两张牌，然后摸一张牌。' },
  {
    source: 'binyi_description',
