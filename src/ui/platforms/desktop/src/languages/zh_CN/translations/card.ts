...
export const cardDescriptions: Word[] = [
  {
    ...
    target:
      '出牌阶段限一次，对你攻击范围内的一名其他角色使用。你对目标角色造成1点伤害。',
  },
  {
    source: 'jink_description',
    target:
      '当【杀】对你生效前，对此【杀】使用。抵消目标【杀】。',
  },
  {
  ...
  },
  {
    ...
    target:
      '出牌阶段，对你距离为1的一名其他角色使用。目标角色判定，若不为梅花，其跳过本回合的下个摸牌阶段。',
  },
  {
    source: 'guohechaiqiao_description',
    target:
      '出牌阶段，对区域内有牌的一名其他角色使用。你弃置目标角色区域里的一张牌。',
  },
  {
  ...
  },
  {
    ...
    target:
      '出牌阶段，对一名其他角色使用。目标角色判定，若不为红桃，其跳过本回合的下一个出牌阶段。',
  },
  {
    source: 'nanmanruqing_description',
    target:
      '出牌阶段，对所有其他角色使用。目标角色需打出一张【杀】，否则受到你造成的1点伤害。',
  },
  {
  ...
  },
  {
    ...
    target:
      '出牌阶段，对所有角色使用。目标角色回复1点体力。',
  },
  {
    source: 'tiesuolianhuan_description',
    target:
      '出牌阶段，对一至两名角色使用。目标角色横置/重置其武将牌。（此牌可重铸）',
  },
  {
    source: 'wanjianqifa_description',
    target:
      '出牌阶段，对所有其他角色使用。目标角色需打出一张【闪】，否则其受到你造成的1点伤害。',
  },
  {
    source: 'wuxiekeji_description',
    target:
      '当锦囊牌对你生效前，对此锦囊牌使用。抵消目标锦囊牌。',
  },
  {
  ...
  },
  {
    ...
    target:
      '出牌阶段，对所有角色使用。亮出牌堆顶等同于目标数的牌，目标角色依次获得其中一张牌。',
  },
  {
    source: 'cixiongjian_description',
    target:
      '当你使用【杀】指定目标后，若其性别与你不同，你可以令其选择一项：1.弃置一张手牌；2.令你摸一张牌。',
  },
  {
    source: 'fangtianhuaji_description',
    target:
      '<b>锁定技</b>，你使用对应实体牌为你所有手牌的【杀】的目标上限+2。',
  },
  {
    source: 'gudingdao_description',
    target:
      '<b>锁定技</b>，当你使用【杀】对目标角色造成伤害时，若其没有手牌，此伤害+1。',
  },
  {
  ...
  },
  {
    ...
    target:
      '<b>锁定技</b>，当你使用【杀】指定目标后，无视其防具。',
  },
  {
    source: 'qinglongyanyuedao_description',
    target:
      '当你使用的【杀】被目标角色抵消后，你可以对其使用一张【杀】（无距离限制）。',
  },
  {
  ...
  },
  {
    ...
    target:
      '当你需要使用或打出【闪】时，你可以判定，若为红色，你视为使用或打出一张【闪】。',
  },
  {
    source: 'baiyinshizi_description',
    target:
      '当你受到伤害时，若伤害值大于1，你将伤害值改为1；当你失去装备区里的此牌后，你回复1点体力。',
  },
  {
  ...
  },
  {
    ...
    target:
      '<b>锁定技</b>，【南蛮入侵】、【万箭齐发】和普【杀】对你无效；当你受到火焰伤害时，此伤害+1。',
  },
  {
    source: 'tengjia_description',
    target:
