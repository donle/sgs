...
export const skillDescriptions: Word[] = [
...

  {
    ...
    target: '<b>锁定技</b>，回合开始时，你执行一个额外的出牌阶段，然后失去1点体力并从弃牌堆中随机获得一张【杀】。',
  },
  {
    source: 'fuli_description',
    target:
      '<b>限定技</b>，当你处于濒死状态时，你可以回复体力至X点并将手牌摸至X张，将你的“当先”修改为“<b>锁定技</b>，回合开始时，你执行一个额外的出牌阶段，然后你可以失去1点体力并从弃牌堆中随机获得一张【杀】”，然后若X不小于3，你翻面（X为存活势力数）。',
  },
