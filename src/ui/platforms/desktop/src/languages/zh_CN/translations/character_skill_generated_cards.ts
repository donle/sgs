...
export const cardDictionary: Word[] = [
  { source: 'qizhengxiangsheng', target: '奇正相生' },
  {
    ...
    target:
      '<b style="color:red">出牌阶段</b>，对一名其他角色使用。你选择“<b style="color:green">奇兵</b>”或“<b style="color:green">正兵</b>”（仅你可见），然后目标角色可以打出一张【杀】或【闪】。若你是“<b style="color:green">奇兵</b>”且目标角色没有打出【杀】，你对其造成1点伤害；若你是“正兵”且目标角色没有打出【闪】，你获得其一张牌。',
  },
  {
