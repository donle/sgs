...
export const skillDescriptions: Word[] = [
  ...
  },
  {
    ...
    target:
      '出牌阶段限一次，你可以令攻击范围内含有你的一名角色选择是否对你使用一张【杀】。若其未使用【杀】或其使用的此【杀】未对你造成伤害，你弃置其一张牌，然后本技能于此阶段内改为“出牌阶段限两次”。',
  },
  {
  ...
  { source: 'duanchang_description', target: '<b>锁定技</b>，当你死亡时，杀死你的角色失去所有技能。' },
  {
    ...
    target:
      '游戏开始时，你随机将武将牌堆里的三张牌扣置于你的武将牌上，称为“化身”，并亮出其中一张且拥有其上由你选择的一个技能（限定技、觉醒技、使命技、隐匿技和主公技除外），然后你的性别及势力视为与此“化身”相同；回合开始或回合结束时，你可以选择一项：1.变更亮出的“化身”；2.移去一至两张未亮出的“化身”并获得等量新“化身”。',
  },
