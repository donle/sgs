...
export const skillDescriptions: Word[] = [
  ...
  },
  {
    ...
    target:
      '<b>锁定技</b>，你点亮的标记拥有如下效果：贪狼：其它角色准备阶段开始时，若你的手牌数不大于体力上限，你可以摸一张牌；文曲：你使用顺手牵羊、过河拆桥、火攻和决斗可以额外增加一个目标；武曲：准备阶段结束时，你可以与一名角色拼点，若你嬴，视为你对其使用一张杀；破军：当你成为其它角色使用牌的目标后，你可以摸一张牌（每回合限x次，x为你已损失的体力值）；每当一种花色的判定牌亮出，或当你杀死一名角色时，你点亮一个阶段的标记。准备阶段开始时，若你已点亮四种标记时，你获得适应性加强。',
  },
  {
