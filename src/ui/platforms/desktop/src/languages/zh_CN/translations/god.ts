...
export const skillDescriptions: Word[] = [
...

  {
    ...
    target:
      '当你于出牌阶段对其他角色造成伤害后，你可以废除一个装备栏，然后选择其武将牌上的一项技能（限定技、觉醒技、使命技、隐匿技和主公技除外），令其于其下回合结束之前此技能无效，且你于其下回合结束或其死亡之前拥有此技能且不能发动“夺锐”。',
  },
  {
  ...
  },
  {
    ...
    target:
      '<b>使命技</b>，游戏开始时，你令所有没有“围”的其他角色各获得一枚“围”标记；有“围”标记的角色受到伤害后，移去其“围”标记；有“围”标记的角色的回合开始时，你可以选择一项，令你于本回合内视为处于其攻击范围内：1.弃置一张手牌，对其造成1点伤害；2.若其体力值不大于你，你获得其一张手牌。回合开始时，你令所有有“围”标记的角色将其“围”标记移至除你外的下家角色。<br><b>成功</b>：回合开始时，若场上没有“围”标记，你获得技能“神著”。<br><b>失败</b>：当你进入濒死状态时，若你的体力小于0，你将体力回复至1点，然后你移去场上的所有“围”标记，并弃置你装备区里的所有牌。',
  },
  {
...

  {
    ...
    target: '<b>锁定技</b>，游戏开始时，将8张【奇正相生】洗入牌堆；【奇正相生】对你无效。',
  },
  {
    source: 'lingce_description',
    target:
      '<b>锁定技</b>，当一名角色使用非虚拟且非转化的锦囊牌时，若此牌为智囊牌、“定汉”已记录的牌或【奇正相生】，你摸一张牌。',
  },
  {
