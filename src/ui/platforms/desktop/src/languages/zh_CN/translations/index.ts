import * as benevolenceCharactersDictionary from './benevolence';
...
import * as strategemCharacterDictionary from './strategem';
...
export {
  ...
  yuan6CharacterDictionary,
  yuan7CharacterDictionary,
