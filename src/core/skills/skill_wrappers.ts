...
export const PersistentSkill = <T extends Skill>(constructorFunction: SKillConstructor<T>) => {
  return class extends ShadowSkill(constructorFunction) {
    public persistentSkill = true;
  } as any;
};
